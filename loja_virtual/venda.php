...
<body>	
	...
	<div class="container-fluid">
		<div class="row" style="margin-top: 15px;">
			<h3 class="text-center"><b>Vendas</b></h3>
		</div>
	            ...
	            <table class="table table-hover">
					...
					<tbody>
						<tr>
	                    	...
	                    	<td><?php echo $exibeVenda['cod_cliente'];?></td>
	                        <td><?php echo $exibeVenda['numero_ticket'];?></td>
	                        <td><?php echo $exibeVenda['nome_produto'];?></td>
	                        <td><?php echo $exibeVenda['qtd_produto'];?></td>
	                        <td><?php echo number_format($exibeVenda['valor_total_item'],2,',','.');?></td> <!--Exibibir o valor com três casas decimais e onde estiver '.' substituir por ','-->
                        </tr>
                        <?php } ?>
              		</tbody>
              	</table>
