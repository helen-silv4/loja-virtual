...
<body>
	<?php 
		...
		$consulta = $cn->query('select cod_produto,nome_produto,valor_preco,descricao_capa,qtd_estoque from view_produto');
		...
		<div class="row">
			<?php while ($exibe = $consulta->fetch(PDO::FETCH_ASSOC)){ ?>
				<div class="col-sm-3">
					...
					<div><h6>R$ <?php echo number_format($exibe['valor_preco'],2,',','.'); ?></h6></div>
